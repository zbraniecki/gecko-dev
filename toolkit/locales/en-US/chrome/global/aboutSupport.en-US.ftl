...
aboutSupport-graphics-webgl2Renderer = WebGL2 Renderer
aboutSupport-graphics-hardwareH264 = Hardware H264 Decoding
aboutSupport-graphics-audioBackend = Audio Backend
...
aboutSupport-contentSandboxLevel = Content Process Sandbox Level
